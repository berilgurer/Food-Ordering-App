<?php
    ...
    $URL = "https://pah-step4-default-rtdb.europe-west1.firebasedatabase.app/messages.json";
...
<form name="form" action = "client_send_message.php?sender=client" method="POST">
